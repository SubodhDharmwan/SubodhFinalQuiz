...
#define DefaultProgressBarProgressColor [UIColor whiteColor]
#define DefaultProgressBarTrackColor [UIColor colorWithRed:28.0/255.0 green:105.0/255.0 blue:164.0/255.0 alpha:1]
const CGFloat DefaultProgressBarWidth = 3.5f;

// Hint View Defaults
#define DefaultHintBackgroundColor [UIColor colorWithRed:94.0/255.0 green:169.0/255.0 blue:227.0/255.0 alpha:1]
#define DefaultHintTextFont [UIFont fontWithName:@"HelveticaNeue-CondensedBlack" size:25.0f]
